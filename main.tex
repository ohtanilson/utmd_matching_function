...
%Clerical jobs are heterogeneous within the industries.

Primary industries show higher efficiency than tertiary industries.
...
\begin{figure}[!ht]
  ...
  \caption{Month-job category level matching elasticity with respect to unemployed 2012-2024}
...
\begin{figure}[!ht]
  \begin{center}
  \subfloat[Across prefectures]{\includegraphics[width = 0.45\textwidth]
  {figuretable/mismatch_part_and_full_time_monthly_prefecture.png}}
  \subfloat[Across job categories]{\includegraphics[width = 0.45\textwidth]
...
%Daiji Kawaguchi, Keisuke Kawata
...
%     \item We want to quantify the bias of the standard Cobb-Douglas specification 
% \end{itemize}
% \begin{frame}{Setup}
%     \begin{itemize}
