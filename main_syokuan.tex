...
\begin{figure}[!ht]
  \begin{center}
  \subfloat[$U_{t}$ and $V_{t}$]{\includegraphics[width = 0.3\textwidth]
  {figuretable/unemployed_year.png}}
  \subfloat[$H_{t}$]{\includegraphics[width = 0.3\textwidth]
  {figuretable/hire_year.png}}
  \subfloat[Bevaledge Curve]{\includegraphics[width = 0.3\textwidth]
  {figuretable/matching_efficiency_year.png}}\\
  \subfloat[$A_{t}$]{\includegraphics[width = 0.3\textwidth]
  {figuretable/matching_efficiency_year.png}}
  \subfloat[$dM/dU,dM/dV$]{\includegraphics[width = 0.3\textwidth]
  {figuretable/elasticity_year.png}}
  \subfloat[$A$ vs TIghtness $V/U$]{\includegraphics[width = 0.3\textwidth]
  {figuretable/elasticity_year.png}}
