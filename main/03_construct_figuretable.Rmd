...
utmd_output_helloworker_data_full_time_monthly <-
  readRDS(file = here::here("output/utmd_output_helloworker_data_full_time_monthly.rds")) %>% 
  dplyr::rename(
    `unemployed`= candidate_count,
    `vacancies` = position_count,
    `hire` = hire_count,
...
utmd_output_helloworker_data_part_time_monthly <-
  readRDS(file = here::here("output/utmd_output_helloworker_data_part_time_monthly.rds")) %>% 
  dplyr::rename(
    `unemployed`= candidate_count,
    `vacancies` = position_count,
    `hire` = hire_count,
...
utmd_output_helloworker_data_part_and_full_time_monthly <-
  readRDS(file = here::here("output/utmd_output_helloworker_data_part_and_full_time_monthly.rds")) %>% 
  dplyr::rename(
    `unemployed`= candidate_count,
    `vacancies` = position_count,
    `hire` = hire_count,
...
### Year-level part-time and full-time
...
x <-
  ggplot(
    utmd_output_helloworker_data_part_and_full_time_monthly,
     aes(
       x = residual_v_on_u_part_and_full_time_monthly,
       y = residual_a_on_u_part_and_full_time_monthly
       )
     ) +
  #geom_line(size = 0.5) +
  geom_point() +
...
x <-
  ggplot(
    utmd_output_helloworker_data_full_time_monthly,
     aes(
       x = residual_v_on_u_full_time_monthly,
       y = residual_a_on_u_full_time_monthly
       )
     ) +
  #geom_line(size = 0.5) +
  geom_point() +
...
x <-
  ggplot(
    utmd_output_helloworker_data_part_time_monthly,
     aes(
       x = residual_v_on_u_part_time_monthly,
       y = residual_a_on_u_part_time_monthly
       )
     ) +
  #geom_line(size = 0.5) +
  geom_point() +
...
x <-
  ggplot(
    utmd_output_hello_work_data_yearly,
     aes(
       x = residual_v_on_u_year,
       y = residual_a_on_u_year
       )
     ) +
  #geom_line(size = 0.5) +
  geom_point() +
...
## Figure 2: Year-level results 1973-2024 {.tabset}
...
## Figure 3: Month-level full-time trends in 1972-2024 {.tabset}
...
## Figure 4: Month-level part-time trends in 1972-2024 {.tabset}
