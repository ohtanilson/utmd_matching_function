...
hello_work_data_part_and_full_time_monthly <-
  ...
  dplyr::mutate(
    unemployed = 
      unemployed +
      hello_work_data_full_time_monthly$unemployed,
    vacancy =
      vacancy +
      hello_work_data_full_time_monthly$vacancy,
    hire = 
      hire +
      hello_work_data_full_time_monthly$hire
  )
...
saveRDS(
  hello_work_data_full_time_monthly,
  file = here::here("cleaned/hello_work_data_full_time_monthly.rds")
)
saveRDS(
  hello_work_data_part_time_monthly,
  file = here::here("cleaned/hello_work_data_part_time_monthly.rds")
)
saveRDS(
  hello_work_data_part_and_full_time_monthly,
  file = here::here("cleaned/hello_work_data_part_and_full_time_monthly.rds")
)
