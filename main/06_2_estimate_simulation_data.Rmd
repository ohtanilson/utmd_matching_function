...
plot_target <-
  plot_target_data(
    target_data = num_time_100_cobb_douglas_0.3_AR1_I0,
    target_variable = "error_efficiency"
    )
plot_target
```
...
plot_target <-
  plot_target_data(
    target_data = num_time_200_cobb_douglas_0.3_AR1_I0,
    target_variable = "error_efficiency"
    )
plot_target
```
...
plot_target <-
  plot_target_data(
    target_data = num_time_50_perfect_substitute_0.3_AR1_I0,
    target_variable = "error_efficiency"
    )
plot_target
```
...
plot_target <-
  plot_target_data(
    target_data = num_time_100_perfect_substitute_0.3_AR1_I0,
    target_variable = "error_efficiency"
    )
plot_target
```
...
plot_target <-
  plot_target_data(
    target_data = num_time_200_perfect_substitute_0.3_AR1_I0,
    target_variable = "error_efficiency"
    )
plot_target
```
...
plot_target <-
  plot_target_data(
    target_data = num_time_50_cobb_douglas_0.3_AR0_I1,
    target_variable = "error_efficiency"
    )
plot_target
```
...
plot_target <-
  plot_target_data(
    target_data = num_time_200_cobb_douglas_0.3_AR0_I1,
    target_variable = "error_efficiency"
    )
plot_target
```
...
plot_target <-
  plot_target_data(
    target_data = num_time_50_perfect_substitute_0.3_AR0_I1,
    target_variable = "error_efficiency"
    )
plot_target
```
...
plot_target <-
  plot_target_data(
    target_data = num_time_100_perfect_substitute_0.3_AR0_I1,
    target_variable = "error_efficiency"
    )
plot_target
```
...
plot_target <-
  plot_target_data(
    target_data = num_time_200_perfect_substitute_0.3_AR0_I1,
    target_variable = "error_efficiency"
    )
plot_target
```
