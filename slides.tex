...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item Elasticities with respect to unemployed and vacancies are \textcolor{blue}{[TBA]}
        \end{enumerate}
        \item Japanese prefecture-level and industry-level labor market via Hello Work in 2012-2024
        \begin{enumerate}
            \item Matching Efficiency is\textbf{ lower in urban area (Tokyo)} and \textcolor{blue}{[TBA]}
...
\begin{itemize}
    \item \textcolor{blue}{Zero elasticity?}
\end{itemize}
\end{frame}
